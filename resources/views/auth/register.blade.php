        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2>Registrate a Planet Express</h2>
                </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('tyc') ? ' has-error' : '' }}">
                            <label for="tyc" class="col-md-4 control-label"><a href="/tyc">Terminos y Condiciones</a></label>

                            <div class="col-md-6">
                                <input id="tyc" type="checkbox" name="tyc" required>
